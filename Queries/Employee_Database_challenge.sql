-- find employee details from the employees detail
SELECT emp_no, first_name, last_name
FROM employees;

-- find title details from the titles table
SELECT title, from_date, to_date
FROM titles;

-- create retirement titles table through employee and titles join
SELECT e.emp_no,
	e.first_name,
	e.last_name,
	ti.title,
...
-- count titles in the unique titles table
SELECT COUNT (title), title
FROM unique_titles
GROUP BY (title);

-- create table to hold the unique titles info
SELECT COUNT (title), title
